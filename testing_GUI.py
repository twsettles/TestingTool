...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.3 on Mon Jul 15 13:18:01 2019
#
...
class TestingFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.text_ctrl_remediation = wx.TextCtrl(self.notebook_1_pane_3, wx.ID_ANY, "")
		...
		self.text_ctrl_wcag = wx.TextCtrl(self.notebook_1_pane_3, wx.ID_ANY, "", style=wx.TE_DONTWRAP | wx.TE_MULTILINE | wx.TE_NO_VSCROLL | wx.TE_READONLY)
		self.text_ctrl_count = wx.TextCtrl(self.notebook_1_pane_3, wx.ID_ANY, "", style=wx.TE_READONLY)
	...
	def __do_layout(self):
		...
		sizer_18 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_1_LoggedIssues, wx.ID_ANY, "Issues"), wx.HORIZONTAL)
		...
		sizer_11 = wx.FlexGridSizer(3, 1, 6, 0)
		...
		sizer_15.Add(self.text_ctrl_issue_summary, 1, wx.EXPAND, 0)
		sizer_11.Add(sizer_15, 1, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 0)
