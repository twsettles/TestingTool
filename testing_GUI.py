...
# -*- coding: ISO-8859-15 -*-
#
# generated by wxGlade 0.9.3 on Thu Sep 12 12:42:27 2019
#
...
class TestingFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.text_ctrl_notes = wx.TextCtrl(self.notebook_1_pane_2, wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.TE_PROCESS_ENTER)
		...
		self.text_ctrl_data = wx.TextCtrl(self.notebook_1_DataFrame, wx.ID_ANY, "", style=wx.TE_MULTILINE)
		...
		self.Bind(wx.EVT_TEXT, self.on_text_notes, self.text_ctrl_notes)
	...
	def __do_layout(self):
		...
		sizer_23 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_1_pane_2, wx.ID_ANY, "Notes"), wx.HORIZONTAL)
		...
		sizer_23.Add(self.text_ctrl_notes, 1, wx.EXPAND, 0)
		sizer_2.Add(sizer_23, 1, wx.EXPAND, 0)
	...
	def on_text_notes(self, event):  # wxGlade: TestingFrame.<event_handler>
		print("Event handler 'on_text_notes' not implemented!")
		event.Skip()
